...
urlpatterns = [
    ...
    path("campanhas/<int:pk>/", views.CampanhaDetailView.as_view(), name="campanha_detalhe"),
    path("campanhas/<int:pk>/editar/", views.CampanhaUpdateView.as_view(), name="campanha_editar"),
    path("campanhas/<int:pk>/encerrar/", views.CampanhaEncerrarView.as_view(), name="campanha_encerrar"),
]
